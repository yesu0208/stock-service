...
////    @Autowired private GithubOAuth2UserService githubOAuth2UserService;
//
...
//        // Given
//        var githubUser = new GithubUser("12345", "test-id", "test-name", "test@eamil.com");
//        var githubUserInfoRequest = new GithubUserInfoRequest(0.01);
//        willDoNothing().given(githubUserInfoService).updateGithubUserFee(githubUser.unchangeableId(), githubUserInfoRequest.toDto());
//
//        // When & Then
...
//        then(githubUserInfoService).should().updateGithubUserFee(githubUser.unchangeableId(), githubUserInfoRequest.toDto());
//    }
//
//}