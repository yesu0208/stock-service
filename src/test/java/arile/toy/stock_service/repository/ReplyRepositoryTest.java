...
class ReplyRepositoryTest {
    ...
    void givenUnchangeableIdAndPostIdAndReplyId_whenSelectingReply_thenReturnsReply() {
        ...
        // When
        Optional<Reply> result = sut.findByUserUnchangeableIdAndPostPostIdAndReplyId(unchangeableId, postId, replyId);

        // Then
        assertThat(result)
                .get()
                .hasFieldOrPropertyWithValue("body", "댓글 내용 1")
    ...
    void givenUnchangeableIdAndPostIdAndReplyId_whenDeletingReply_thenDeletesReply() {
        ...
        // Then
        assertThat(sut.findByUserUnchangeableIdAndPostPostIdAndReplyId(unchangeableId, postId, replyId)).isEmpty();
    }
