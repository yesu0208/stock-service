...
class DislikeRepositoryTest {
    ...
    @Test
    void givenGithubUserInfoAndPost_whenSelectingDislike_thenReturnsDislike() {
        // Given
        ...
        var schema = new Dislike(githubUserInfo, post);
        sut.save(schema);

        // When
        Optional<Dislike> result = sut.findByGithubUserInfoAndPost(githubUserInfo, post);
